...
type PermissionsClient interface {
	GetUserPermissions(ctx context.Context, in *UserPermissionsRequest, opts ...grpc.CallOption) (*UserPermissions, error)
}
...
func (c *permissionsClient) GetUserPermissions(ctx context.Context, in *UserPermissionsRequest, opts ...grpc.CallOption) (*UserPermissions, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PermissionsServer interface {
	GetUserPermissions(context.Context, *UserPermissionsRequest) (*UserPermissions, error)
...
func (UnimplementedPermissionsServer) GetUserPermissions(context.Context, *UserPermissionsRequest) (*UserPermissions, error) {
...
func _Permissions_GetUserPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionsServer).GetUserPermissions(ctx, req.(*UserPermissionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
